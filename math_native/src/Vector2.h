...
class Vector2 : public node::ObjectWrap {
 public:
 ...
 private:
  ...
  static v8::Handle<v8::Value> getVector2X(v8::Local<v8::String> property, const v8::AccessorInfo& info);
  static void setVector2X(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
  static v8::Handle<v8::Value> getVector2Y(v8::Local<v8::String> property, const v8::AccessorInfo& info);
  static void setVector2Y(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
